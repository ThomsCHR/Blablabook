  ...
  <div class="book-details-container">
    ...
    <div class="left-section">
      <div class="cover-container">
        <div
          ...
          style={book?.image ? `background-image:url(${book.image});background-size:cover;background-position:center;` : ""}
        >
          <div class="book-menu">
            <button
            ...
            {#if menuOpen}
              <ul class="book-menu-dropdown">
                <li>
                  <button class="book-status-btn" on:click={() => setStatus("to_read")} disabled={saving}>
                    À lire
                  </button>
                </li>
                <li>
                  <button class="book-status-btn" on:click={() => setStatus("read")} disabled={saving}>
                    Lu
                  </button>
                </li>
              </ul>
    ...
    <div class="right-section">
      <div class="book-info">
        ...
        <p class="book-author">de <strong>{book?.author || "Auteur inconnu"}</strong></p>
        ...
        {#if book?.publication_date}
          <p class="book-year"><span class="label">Année :</span> {book.publication_date}</p>
        {/if}
...
<style>
  .book-info {
    padding: 1.5rem 2rem;
    border-left: 3px solid #2c3e50;  /* juste une barre latérale pour structurer */
  }
